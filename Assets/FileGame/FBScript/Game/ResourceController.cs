...
public class ResourceController : MonoBehaviour
{
    ...
    private int _level
    {
        set
        {
            // menyimpan value di set ke _level pada progress data
    ...
    public void SetConfig(int index, ResourceConfig config)  // (FBResourceConfig config)
    {
        _index = index;
        _config = config;
    ...
    public void UpgradeLevel()
    {
        ...
        // if (FBGameManager.Instance.TotalGold < upgradeCost)
     ...
     public void UnlockResource()
    {
        ...
        // if(FBGameManager.Instance.TotalGold < unlockCost)
